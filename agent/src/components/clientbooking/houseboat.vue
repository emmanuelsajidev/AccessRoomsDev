<template>
  <div>
    ...
    <v-layout wrap class="hidden-sm-and-down" justify-center>
                          ...
                          <v-flex xs12 pt-4>
                            <v-layout wrap>
                              ...
                              <v-flex xs2 class="black-border">
                                <v-layout wrap justify-center>
                                  <v-flex xs12 pr-2>
                                    <v-autocomplete flat dense color="black" :items="rooms" v-model="room"
                                      item-text="name" item-color="#FF1313" hide-details="true" clearable
                                      class="custom-autocomplete rounded-lg">
                                      <template v-slot:append>
                                        <v-layout wrap justify-start>
                              ...
                              <v-flex xs2 class="black-border">
                                <v-layout wrap justify-center>
                                  <v-flex xs12 pr-2>
                                    <v-autocomplete flat dense color="black" :items="triptypes" v-model="triptype"
                                      item-text="name" item-color="#FF1313" hide-details="true" clearable
                                      class="custom-autocomplete rounded-lg">
                                      <template v-slot:append>
                                        <v-layout wrap justify-start>
      ...
      <v-layout wrap justify-center>
        <v-flex xs12 pr-2>
          <v-menu ref="menuCheckIn" v-model="menuCheckInVisible" :close-on-content-click="false" max-width="290" style="box-shadow: none">
            <template v-slot:activator="{ on, attrs }">
              <v-text-field class="text-field-transparent" dense hide-details="auto" v-model="checkInDate" v-bind="attrs" background-color="white" v-on="on" @click:clear="checkInDate = null" style="color: black; box-shadow: none;">
                <template v-slot:append>
                  <v-layout wrap>
                    <v-flex pt-1>
            ...
            <v-date-picker style="box-shadow: none" v-model="checkInDate" color="#13736f" @change="menuCheckInVisible = false"></v-date-picker>
          </v-menu>
        </v-flex>
      </v-layout>
    </v-flex>
    ...
    <v-flex xs2 class="black-borderv">
      <v-layout wrap justify-center>
        <v-flex xs12 pr-2>
          <v-menu ref="menuCheckOut" v-model="menuCheckOutVisible" :close-on-content-click="false" max-width="290" style="box-shadow: none">
            <template v-slot:activator="{ on, attrs }">
              <v-text-field class="text-field-transparent" dense hide-details="auto" v-model="checkOutDate" v-bind="attrs" background-color="white" v-on="on" @click:clear="checkOutDate = null" style="color: black; box-shadow: none;">
                <template v-slot:append>
                  <v-layout wrap>
                    <v-flex pt-1>
                      <v-icon color="black">mdi-calendar</v-icon>
            ...
            <v-date-picker style="box-shadow: none" v-model="checkOutDate" color="#13736f" @change="menuCheckOutVisible = false"></v-date-picker>
          </v-menu>
        </v-flex>
      </v-layout>
    </v-flex>
                        ...
                        <v-layout wrap justify-center>
                          <v-flex xs2>
                            <v-btn block color="#FF6200">
                              <span style="font-weight:500;color:white;font-size: 18px;font-family: LexendRegular; text-transform: none;">Search</span>
                          ...
                          <v-layout wrap pb-3 justify-center>
                            <v-flex xs11 v-for="index in 3" :key="index" pt-5>
                              <v-card elevation="2">
                                <v-layout wrap justify-center>
                                  <v-flex xs12 pa-3>
                                    <v-layout wrap justify-center pr-3>
                                      <v-flex xs2>
                                          ...
                                          <v-flex xs9 text-left align-self-center>
                                            <v-layout wrap>
                                              <v-flex xs12 text-left>
                                                <span
                                                  style="font-weight: 500;font-size: 20px;font-weight:bold;font-family: LexendRegular;">Queen
                                                  of Alappy</span>

                                              </v-flex>
                                              <v-flex xs12 pr-3 text-right>
                                                <span
                                                  style="font-family: LexendRegular;font-size: 12px;font-weight:500">Houseboat</span>
                                              </v-flex>
                                            </v-layout>
                                        ...
                                        <v-layout wrap fill-height justify-center>
                                          <v-flex xs9 text-left align-self-center>
                                            <v-layout wrap>
                                              <v-flex xs12 text-left>
                                                <span
                                                  style="font-family: LexendRegular;color:#757575;font-size: 14px;font-weight:400">
                                                  Rooms</span>
                                                <br />
                                                <span
                                        ...
                                        <v-layout wrap fill-height justify-center>
                                          <v-flex xs9 text-left align-self-center>
                                            <v-layout wrap>
                                              <v-flex xs12 text-left>
                                                <span
                                                  style="font-family: LexendRegular;color:#757575;font-size: 14px;font-weight:400">Houseboat
                                                  type</span>
                                                <br />
                                                <span
                                                  style="font-family: LexendRegular;color:black;font-size: 18px;font-weight:600">
                                        ...
                                        <v-layout wrap fill-height justify-center>
                                          <v-flex xs9 text-left align-self-center>
                                            <v-layout wrap>
                                              <v-flex xs12 text-left>
                                                <span
                                                  style="font-family: LexendRegular;color:#757575;font-size: 14px;font-weight:400">Category</span>
                                                <br>
                                                <span
                                                  style="font-family: LexendRegular;color:black;font-size: 18px;font-weight:600">
                                                  Deluxe
    ...
    <v-layout pt-3 wrap class="hidden-md-and-up" justify-center>
      <v-flex xs11>
        <v-layout wrap pt-16 justify-center>
          ...
          <v-flex class="black-border" xs10 style="font-weight: 400;font-size: 20px;font-family: LexendRegular;">
            <v-autocomplete flat dense color="black" :items="rooms" v-model="room" item-text="name" item-color="#FF1313"
              hide-details="true" clearable class="custom-autocomplete rounded-lg">
              <template v-slot:append>
                <v-layout wrap justify-start>
                  <v-flex xs1 pt-1>
          ...
          <v-flex class="black-border" xs10 style="font-weight: 400;font-size: 20px;font-family: LexendRegular;">
            <v-menu ref="menuCheckIn" v-model="menuCheckIn" :close-on-content-click="false" max-width="290"
              style="box-shadow: none">
              <template v-slot:activator="{ on, attrs }">
                <v-text-field class="text-field-transparent" dense hide-details="auto" v-model="checkInDate"
                  v-bind="attrs" v-on="on" @click:clear="checkInDate = null" style="color: black; box-shadow: none;">
                  <template v-slot:append>
                    <v-icon color="black">mdi-calendar</v-icon>
                  </template>
                  <template v-slot:label>
          ...
          <v-flex class="black-border" xs10 style="font-weight: 400;font-size: 20px;font-family: LexendRegular;">
            <v-menu ref="menuCheckOut" v-model="menuCheckOut" :close-on-content-click="false" max-width="290"
              style="box-shadow: none">
              <template v-slot:activator="{ on, attrs }">
                <v-text-field class="text-field-transparent" dense hide-details="auto" v-model="checkOutDate"
                  v-bind="attrs" v-on="on" @click:clear="checkOutDate = null" style="color: black; box-shadow: none;">
                  <template v-slot:append>
                    <v-icon color="black">mdi-calendar</v-icon>
                  </template>
                  <template v-slot:label>
              ...
              <v-date-picker style="box-shadow: none" v-model="checkOutDate" color="#13736f"
                @change="menuCheckOut = false"></v-date-picker>
            </v-menu>
          </v-flex>
                    ...
                    <v-flex xs12>
                      <v-layout wrap fill-height justify-center>
                        <v-flex xs12 text-left align-self-center>
                          <v-layout wrap>
                            <v-flex xs12 text-left>
                              <span style="font-weight: 500;font-size: 20px;font-family: LexendRegular;">Queen of
                                Alappy</span>

                            </v-flex>
                            <v-flex xs12 text-left>
                              <span style="font-family: LexendRegular;font-size: 12px;font-weight:500">Houseboat</span>
                            </v-flex>
                          </v-layout>
                      ...
                      <v-layout wrap fill-height justify-center>
                        <v-flex xs12 text-left align-self-center>
                          <v-layout wrap>
                            <v-flex xs12 text-left align-self-center>
                              <span
                                style="font-family: LexendRegular;color:#757575;font-size: 14px;font-weight:400">Rooms</span>
                              <br>
