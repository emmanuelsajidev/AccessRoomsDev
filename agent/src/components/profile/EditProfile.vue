<template>
  <div>
    ...
    <v-layout wrap>
      <!-- AgentId Proof Front -->
      <v-flex xs12 sm6 lg6 pr-4>
        <v-layout wrap class="file-upload-container">
          <v-flex xs12 sm6 lg6>
            <span class="file-upload-title">AgentId Proof Front</span>
          ...
          <v-flex xs12 sm6 lg6>
            <v-file-input v-model="file2" label="Upload file" class="file-upload-input"></v-file-input>
          </v-flex>
        </v-layout>
      </v-flex>

      <!-- Agent GST Proof -->
      <v-flex xs12 sm6 lg6 pr-4 pl-lg-10>
        <v-layout wrap class="file-upload-container">
          <v-flex xs12 sm6 lg6>
            <span class="file-upload-title">Agent GST Proof</span>
          ...
          <v-flex xs12 sm6 lg6>
            <v-file-input v-model="file3" label="Upload file" class="file-upload-input"></v-file-input>
          </v-flex>
        </v-layout>
      </v-flex>

      <!-- AgentId Proof Back -->
      <v-flex xs12 sm6 lg6 pr-4 pt-lg-10>
        <v-layout wrap class="file-upload-container">
          <v-flex xs12 sm6 lg6>
            <span class="file-upload-title">AgentId Proof Back</span>
          ...
          <v-flex xs12 sm6 lg6>
            <v-file-input v-model="file4" label="Upload file" class="file-upload-input"></v-file-input>
          </v-flex>
        </v-layout>
      </v-flex>
    </v-layout>
          ...
          <v-layout wrap>
            <v-flex xs12 pt-lg-10 pt-0>
              <v-layout wrap justify-end>
                <v-flex xs12 lg2>
                  <v-btn @click="editProfile()" color="#FF681F" block>
