              ...
              <v-flex xs2 @click="guest = true" class="black-border">
                <v-layout wrap justify-center>
                  <v-flex xs11 pr-2 pt-1>
                    <span style="color: black; font-size: 14px" class="font4">
                      No.of Guests
                    </span>
                  </v-flex>
                  <v-flex xs1 pt-1>
                  ...
                  <v-flex xs12 pr-2>
                    ...
                    >
                      ...
                      <v-time-picker
                        ...
                        v-model="checkInTime"
                        full-width
                        @click:minute="$refs.checkInMenu.save(checkInTime)"
                      ></v-time-picker>
                    </v-menu>
                  </v-flex>
                </v-layout>
                  ...
                  <v-flex xs12 pr-2>
                    ...
                    >
                      ...
                      <v-time-picker
                        ...
                        v-model="checkOutTime"
                        full-width
                        @click:minute="$refs.checkOutMenu.save(checkOutTime)"
                      ></v-time-picker>
                    </v-menu>
                  </v-flex>
                </v-layout>
        ...
        <v-layout wrap pt-4 justify-center>
          ...
          >
            ...
            >
              ...
              <template v-slot:label>
                <span class="font4" style="color: black; font-size: 14px">
                  Category</span
                >
              </template>
            </v-autocomplete>
          ...
          <v-flex xs12 sm6 class="black-borderm">
            <v-layout wrap justify-center>
              <v-flex xs12 pr-2>
                <v-menu
                  ref="menuCheckIn2"
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      ...
                      dense
                      hide-details="auto"
                      v-model="checkInDatem"
                      v-bind="attrs"
                      v-on="on"
                      @click:clear="checkInDatem = null"
                      style="color: black; box-shadow: none"
                    >
                      <template v-slot:append>
                        <v-layout wrap>
                  ...
                  <v-date-picker
                    ...
                    v-model="checkInDatem"
                    color="#13736f"
                    @change="menuCheckIn2 = false"
                  ></v-date-picker>
                </v-menu>
              </v-flex>
            </v-layout>
          </v-flex>
          <v-flex xs12 sm6 class="black-borderv">
            <v-layout wrap justify-center>
              <v-flex xs12>
                <v-menu
                  ref="checkInMenu2"
                  v-model="checkInMenuVisible2"
                  :close-on-content-click="false"
                  :nudge-right="40"
                  :return-value.sync="checkInTime2"
                  transition="scale-transition"
                  offset-y
                  max-width="290px"
                  min-width="290px"
                >
                  ...
                  <v-time-picker
                    v-if="checkInMenuVisible2"
                    v-model="checkInTime2"
                    full-width
                    @click:minute="$refs.checkInMenu2.save(checkInTime2)"
                  ></v-time-picker>
                </v-menu>
              </v-flex>
            </v-layout>
          ...
          <v-flex xs12 sm6 class="black-borderv">
            <v-layout wrap justify-center>
              <v-flex xs12>
                <v-menu
                  ref="checkOutMenu2"
                  v-model="checkOutMenuVisible2"
                  :close-on-content-click="false"
                  :nudge-right="40"
                  :return-value.sync="checkOutTime2"
                  transition="scale-transition"
                  offset-y
                  max-width="290px"
                  min-width="290px"
                >
                  ...
                  <v-time-picker
                    v-if="checkOutMenuVisible2"
                    v-model="checkOutTime2"
                    full-width
                    @click:minute="$refs.checkOutMenu2.save(checkOutTime2)"
                  ></v-time-picker>
                </v-menu>
              </v-flex>
            </v-layout>
      ...
      axios({
        ...
        .then((response) => {
          ...
          if (response.data.status) {
            ...
            this.$router.push("/ViewShikara?type='search'");
          } else {
            this.products = [];
          }
        })
