    ...
    <div>
      <v-img src="./../../assets/images/reg1.png">
        <v-layout wrap justify-center pt-10>
          <v-flex xs12 sm6 md4 text-center pt-xs-0 pt-sm-10 pt-lg-15 pt-md-10 pt-xl-15>
            <v-layout wrap justify-center>
              <v-flex xs12>
                <span style="font-family: LexendFont;font-weight: 500;"
                :style="{'font-size': 
              ...
              <v-flex xs12>
                <span style="font-family: RobotoLight;font-weight:400;"
                :style="{'font-size': 
                   $vuetify.breakpoint.name == 'xs'
                  ? '15px'
                  : $vuetify.breakpoint.name == 'sm'
                  ...
                  ? '18px'
                  : '30px', }"
                  >Please provide us with the necessary details to enhance your experience and ensure everything runs smoothly.</span
                >
              </v-flex>
            </v-layout>
          </v-flex>
          ...
          <v-card rounded="xl">
            <v-layout wrap justify-center px-10 py-10>
              <v-flex xs11 sm10>
                <v-layout wrap justify-center>
                  <v-flex xs12 pb-8>
                    <v-img contain src="./../../assets/images/reg2Bar.png"></v-img>
                  </v-flex>
                  <v-flex xs12>
                    <v-divider></v-divider>
                  </v-flex>
                  <v-flex xs12 pb-2 pt-5>
                    <span style="font-family: LexendFont;font-size: 22px;font-weight: 400;">Additional Information </span>
                  </v-flex>
                  <v-flex
                    xs12
                    pt-3
                  ...
                  >
                    ...
                    <v-radio-group v-model="isGst" column :hide-details="true">
                  ...
                  >
                    ...
                    <v-text-field dense outlined v-model="gstNo">
                    </v-text-field>
                  </v-flex>
                  <v-flex
                    xs12
                  ...
                  >
                    ...
                    <v-text-field dense outlined :rules="Rules" v-model="state">
                    </v-text-field>
                  </v-flex>
                  <v-flex
                    xs12
                  ...
                  >
                    ...
                    <v-text-field dense outlined :rules="Rules" v-model="country">
                    </v-text-field>
                  </v-flex>
                  <v-flex
                    xs12
                  ...
                  >
                    ...
                    <v-text-field dense outlined :rules="Rules" v-model="pincode" type="number">
                    </v-text-field>
                  </v-flex>
                  <v-flex
                    xs12
                        ...
                        <v-layout wrap pa-3>
                          <v-flex xs12 md12 lg12 :key="lon">
                            ...
                            >
                              ...
                              <!-- Loop through the markers array and create markers for each position -->
                              <gmap-marker
                                :key="index"
                  ...
                  <v-flex
                    xs12
                    style="font-family: LexendRegular; font-size: 13px" pt-6
                  >
                    <span class="font3">ID Proof </span><span style="color: rgba(241, 115, 67, 1);">*</span><span style="font-family: LexendFont;font-size: 14px;font-weight: 300;color: grey;">ID proof *front & back side in single file</span>
                    <v-file-input label="File input" outlined dense class="pt-2" v-model="voteridProof"  @change="getFiles">
                      <template v-slot:append>
                        <!-- <v-btn text color="#F17343"> -->
                          <v-btn dense class="hidden-xs-only" small style="
                  background: linear-gradient(to bottom,rgba(255, 133, 86, 1),rgba(247, 75, 9, 1),rgba(255, 70, 0, 1));
                  color: white;
                "><span style="color: white;">Choose File</span></v-btn>
                  ...
                  <v-flex
                    ...
                    style="font-family: LexendRegular; font-size: 13px"
                  >
                    <span class="font3">Company Registration</span><span style="color: rgba(241, 115, 67, 1);">*</span><span style="font-family: LexendFont;font-size: 14px;font-weight: 300;color: grey;"> front & back side in single file</span>
                    <v-file-input label="File input" outlined dense class="pt-2" v-model="licenseProof" @change="getFiles2">
                      <template v-slot:append>
                        <!-- <v-btn text color="#F17343"> -->
                          <v-btn dense class="hidden-xs-only" small style="
                  background: linear-gradient(to bottom,rgba(255, 133, 86, 1),rgba(247, 75, 9, 1),rgba(255, 70, 0, 1));
          ...
          <v-layout wrap justify-space-between pt-10>
            ...
            <v-flex xs12 sm6 md3 text-right>
              ...
              <v-btn
                ...
                @click="validation()"
                style="
                  background: linear-gradient(to bottom,rgba(255, 125, 20, 1),rgba(241, 115, 67, 1));
                  color: white;
                "
                ><span style="font-family: LexendRegular; text-transform: none"
                  >Next</span
    ...
    <v-dialog width="450px" v-model="confirmDialog">
          <v-card width="450px" class="pa-2" style="border-radius: 10px;">
            ...
            <v-flex xs11 py-6 text-center>
              <span style="font-family: LexendFont;font-weight: 600;font-size: 20px;color: black;">Are you sure you want <br/>to leave?</span>
            </v-flex>
            ...
            <v-flex xs11 text-center pb-6>
              <span
              style="font-family: RobotoLight;font-weight: 400;font-size: 18px;color: black;">
              Profile verification will commence only <br/>after you have completed all the<br/> required details.</span>
            </v-flex>
            <v-flex xs11 sm5 text-left pb-6>
              <v-btn color="rgba(241, 115, 67, 1)" outlined>
                <span style="font-family: LexendFont;font-weight: 400;font-size: 18px;color:rgba(241, 115, 67, 1);">Leave</span>
              </v-btn>
</v-flex>
<v-flex xs11 sm5 text-right pb-6>
              <v-btn color="rgba(241, 115, 67, 1)" dark @click="confirmDialog=true">
                <span style="font-family: LexendFont;font-weight: 400;font-size: 18px;color:white;">Continue</span>
              </v-btn>
</v-flex>
            </v-layout>
...
export default {
  beforeRouteLeave(to, from, next) {
    if (from.name === "stepTwo" && to.name === "stepOne") {
      ...
      // Store the next callback to handle navigation after user input
      this.navigationCallback = next;
    } else {
      // For other routes, allow navigation without confirmation dialog
      next();
    }
  },
  data() {
