                      ...
                      <v-layout wrap pt-4>
                        <v-flex xs3 pb-2 text-center>
                          ...
                          <span
                            ...
                            >Full view</span
                          >
                          <v-chip small v-if="fullImage">{{ fullImage.name }}</v-chip>
                        </v-flex>
                        <v-flex xs3 pb-2 text-center>
                          <v-card
                            tile
                          ...
                          >
                          <v-chip small v-if="upperImage">{{ upperImage.name }}</v-chip>
                        </v-flex>
                        <v-flex xs3 pb-2 text-center>
                          <v-card
                            tile
                          ...
                          <span
                            ...
                            >Interior</span
                          >
                          <v-chip small v-if="interiorImage">{{ interiorImage.name }}</v-chip>
                        </v-flex>
                        <v-flex xs3 pb-2 text-center>
                          <v-card
                            tile
