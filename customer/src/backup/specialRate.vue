    ...
    >
      <v-layout wrap justify-center>
        ...
        <v-layout wrap justify-space-around pt-0 pt-sm-2>
          <v-flex xs12 >
            <v-card tile class="pa-4 pa-sm-6" >Special rate-{{this.choosedDay2.dateFormat}}
              <vue-horizontal-calendar  style="width:410px;height:90px;margin: 0 auto;"
  swipeSpace="7" choosedDate="2019/12/01" v-on:change="dateChange2" lang="en"></vue-horizontal-calendar>
                </v-card>
                </v-flex>
                </v-layout>
    </div>
