<template>
  <div>
    ...
    <v-layout class="mainfont" wrap justify-center pa-0 pa-4>
      <v-flex xs12>
                              ...
                              <v-layout wrap justify-start>
                                <v-flex xs12>
                                  <v-img
                                    ...
                                    :src="
                                      mediaURLnewx + item.houseBoatId.coverImage
                                    "
                                    :height="
                                      $vuetify.breakpoint.name == 'xs'
                                        ? '180px'
                                          ...
                                          @click="
                                            $router.push(
                                              '/houseboatReservationEdit?id=' +
                                                item._id+'&&boatid='+item.houseBoatId._id
                                            )
                                          "
                                          small
                                          dark
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      axios({
        method: "get",
        url: "/admin/reservation/all/houseboat",
        headers: {
    ...
    getcancelledList() {
      ...
      axios({
        method: "get",
        url: "/admin/reservation/houseboat/cancelled/getlist",
        headers: {
          token: localStorage.getItem("token"),
        },
        params: {
    ...
    cancelReservation() {
      ...
      axios({
        method: "get",
        url: "/admin/reservation/houseboat/cancel",
        params: {
          id: this.deleteId,
        },
        headers: {
