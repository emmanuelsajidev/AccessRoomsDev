                          ...
                          <v-layout wrap justify-start v-if="gallery.length > 0">
                              ...
                              <div class="images" v-viewer >
                                  <v-card elevation="0"  height="250px"
                                      ...
                                      <img :src="mediaURLnewx + item" style="object-fit: cover;" height="250px"
                                          width="250px" />
                                  </v-card>
                              </div>
                              <v-btn  @click="(deleteialog=true),(deleteId=i)" class="mr-3"  small width="248px" color="rgba(255, 98, 0, 1)"><span
                            style="font-family: mainfont;color: white;text-transform: none"
          ...
          <v-card width="400px" class="pa-2">
            <v-layout wrap justify-center>
              <v-flex xs11 text-center
                ><span style="color: rgba(0, 38, 53, 1)" class="dialogHead"
                  >Delete</span
                ></v-flex
              >
              <v-flex xs1 text-right>
                <v-icon @click="deleteialog = false" color="rgba(0, 38, 53, 1)"
