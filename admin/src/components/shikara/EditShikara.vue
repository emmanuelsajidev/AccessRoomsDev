                  ...
                  <v-layout wrap justify-end>
                    <v-flex xs12 sm2>
                      <v-btn
                        ...
                        ><span
                          style="font-family: mainfont; text-transform: none"
                          >Save</span
                        ></v-btn
                      >
                    </v-flex>
    ...
    getData() {
      ...
      axios({
        ...
        .then((response) => {
          ...
          this.sid = response.data.data.startingLocation._id;
          console.log("eweewe",this.sid)

          this.locationid = this.shikaraData.location._id;
          this.subid = this.shikaraData.startingLocation.locationId;
