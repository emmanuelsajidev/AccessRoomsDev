<template>
  <div>
    ...
    <v-layout wrap pb-9>
                      ...
                      <v-layout wrap justify-center fill-height>
                        ...
                        >
                          <v-btn
                            @click="
                              $router.push(
                                '/locationdetailedview?id=' + item._id
                              )
                            "
                            color="#3E69B4"
                            block
                          >
                            <span style="color: white; text-transform: none"
                              >View Details</span
                            >&nbsp;
                            <v-icon size="100%" color="white">mdi-eye</v-icon>
                          </v-btn>
                        </v-flex>
                      </v-layout>
                    </v-flex>
      ...
      <v-dialog :retain-focus="true" persistent v-model="sub" max-width="550px">
        <v-card>
          <v-layout wrap justify-center>
            <v-flex
              ><v-layout wrap justify-center pa-3>
                <v-flex xs12 text-right>
                  <v-icon @click="sub = false" color="red" size="150%" dark>
                    mdi-close
                  </v-icon>
                </v-flex>
                <v-flex xs10>
...
export default {
  ...
  methods: {
    ...
    submitEdit() {
      ...
      // Check if topImage is defined before appending it to formData3
      if (this.topImage) {
