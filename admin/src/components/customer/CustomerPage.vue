<template>
        ...
        <v-flex xs12 justify-center>
          <v-layout v-if="list.length > 0" wrap justify-center>
            <v-flex xs12>
                        ...
                        <v-layout wrap justify-center pb-4>
                          ...
                          <v-flex xs11>
                            <v-layout wrap justify-center>
                              ...
                              <v-flex xs11 lg11 pt-3 style="font-size: 14px;">
                                <strong>Email:</strong>
              ...
              <v-layout wrap>
                <v-flex xs12 pt-10 pb-8 class="mainbg6 mainfont" align-self-end>
                  <v-pagination
  ...
  export default {
    ...
    methods: {
      getLocalStoragePage() {
        return localStorage.getItem("paginationPage12");
      },
      setLocalStoragePage(value) {
        localStorage.setItem("paginationPage12", value);
      },
      deleteVendor(userId) {
        axios({
          method: "POST",
