                ...
                <v-layout wrap justify-center py-2>
                  ...
                  <v-flex xs12>
                    <v-layout wrap>
                      ...
                      <v-flex xs11 sm6 md2 lg2 xl2 pl-2 pt-2 align-self-center>
                        <v-autocomplete
                          flat
                          outlined
                          dense
                    ...
                    <v-card tile class="pa-4 pa-sm-6">
                      <v-simple-table>
                        <template v-slot:default>
                          <thead>
                            <tr class="mainfont">
                              <th class="text-left mainfont">Sl No.</th>
                              <th class="text-left mainfont">Houseboat Name</th>
                              <th class="text-left mainfont">
                                Customer/ Agent Name
                              </th>
                              <th class="text-left mainfont">Booked By</th>
                              <th class="text-left mainfont">Check-In Date</th>
                              <th class="text-left mainfont">Check-Out Date</th>
                              <th class="text-left mainfont">Trip-Type</th>
                              <th class="text-left mainfont">No. of Rooms</th>
                              <th class="text-left mainfont">Total Amount</th>
                              <th class="text-left mainfont">
                                Houseboat Total Amount
                              </th>
                              <th class="text-left mainfont">Advance Amount</th>
                          ...
                          <tbody>
                            <tr v-for="(value, i) in reportData" :key="i">
                              ...
                              <td class="mainfont">
                                ...
                                <br>
                                <span v-if="value.status == 'Cancelled'" style="color:red;"> {{value.status}}</span>
                              ...
                              <td class="mainfont">{{ value.bookingType }}</td>
                              <td class="mainfont">
                              ...
                              <td>
                                <span class="mainfont" v-if="value.totalRooms">
                                  {{ value.totalRooms }}
                                </span>
                                <span class="mainfont" v-else> 0 </span>
                              </td>
...
getExcel() {
    ...
    uploadReciept(itemid) {
      ...
      axios({
        method: "POST",
        url: "/admin/upload/hbaccesspayreceipt",
        headers: {
          token: localStorage.getItem("token"),
        },
        data: this.formData,
    ...
    getData() {
      this.appLoading = true;
      axios({
        url: "/admin/houseboat/settlement",
        method: "Post",
        headers: {
          token: localStorage.getItem("token"),
        },
