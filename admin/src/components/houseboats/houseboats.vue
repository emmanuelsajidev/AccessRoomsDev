<template>
    <div>
            ...
            <v-flex xs11 text-right>
              <v-layout wrap justify-center>
                <v-flex xs7 lg9 pt-2 text-left>
                  <span class="mainfont" style="font-size: 25px;font-weight: bolder;">HOUSEBOATS</span>
                </v-flex>
                <v-flex xs4 lg3>
                  <v-text-field
                    v-model="keyword"
        ...
        <v-layout wrap>
            ...
            <v-flex class="mainfont" xs11 sm5 md4 lg4 xl3 v-for="(item, i) in list" :key="i" pt-8>
                <v-layout wrap justify-center>
                    <v-flex xs12 lg10>
                        <v-card>
                                ...
                                <v-flex xs12 sm8 lg12>
                                    <v-layout wrap justify-center fill-height>
                                        <v-flex xs11 lg11 pt-3 align-self-center>
                                            <strong>House Boat Name:</strong> {{ item.houseBoatName }}
                                        ...
                                        align-self-center
                                            @click="$router.push('/houseboatdetailedview?id=' + item._id)">
