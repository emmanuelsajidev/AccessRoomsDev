                    ...
                    <v-flex xs12 sm8 lg12>
                      <v-layout wrap justify-center fill-height>
                        ...
                        <v-flex
                          ...
                          align-self-center
                          @click="
                            (unblockdialog = true), (houseBoatId = item._id)
                          "
                        >
          ...
          <v-card>
            <v-layout wrap>
              <v-flex xs12>
                ...
                >
                  Are you sure you want to unblock the houseboat?
                </v-card-title>
              </v-flex>
            </v-layout>
            <v-card-actions>
              ...
              <v-btn
                ...
                class="mainfont"
                text
                @click="unblockHouseboat(houseBoatId)"
                >OK</v-btn
              >
              <v-spacer></v-spacer>
            </v-card-actions>
...
export default {
  ...
  methods: {
    unblockHouseboat(houseBoatId) {
      axios({
        method: "POST",
        url: "/houseboat/unblock",
        headers: {
