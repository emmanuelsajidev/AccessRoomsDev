  ...
  <div>
    ...
    <v-layout wrap justify-center pa-4>
     ...
     <v-flex xs12 sm2 align-self-center text-left px-2>
                    ...
                    <v-flex xs12 sm3 align-self-center text-left px-2>
                      <v-layout wrap>
                        <v-flex xs9 sm12 align-self-center>
                      <span
                        style="
                ...
                <v-flex
                  ...
                  >Package</v-flex
                >
                <v-flex text-right xs7 md2 pt-2 pt-sm-4 px-2 @click="addPackage = true">
                  <span
                    style="
                      color: #ff6200;
                      font-family: LexendFont;
              ...
              <!-- <v-flex xs12 sm10 pt-4 text-left>
                    ...
                    >
                      ...
                      <v-time-picker
                        ...
                        v-model="curItem.firstDayStartTime"
                        full-width
                        @click:minute="$refs.menu5.save(curItem.firstDayStartTime)"
                      ></v-time-picker>
                    </v-menu>
                  </v-flex>
                  <v-flex xs12 sm10 pt-4 text-left>
                    ...
                    >
                      ...
                      <v-time-picker
                        ...
                        v-model="curItem.firstDayEndTime"
                        full-width
                        @click:minute="$refs.menu6.save(curItem.firstDayEndTime)"
                      ></v-time-picker>
                    </v-menu>
                  </v-flex> -->
          ...
          <v-layout wrap justify-start>
            <v-flex xs12>
              <v-layout wrap justify-center>
                ...
                <v-flex xs12 sm10 pt-4 text-left>
                  <span class="title2 pr-2">Customer Extra person rate</span>
                  <v-text-field
                    dense
                    outlined
                    type="number"
