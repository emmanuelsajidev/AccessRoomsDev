        ...
        <v-layout wrap justify-start pt-2>
          <v-flex xs12 align-self-center>
            <span
              ...
              >Houseboat bookings</span
            >
          </v-flex>
        </v-layout>
        <v-layout wrap justify-end v-if="list">
          <v-flex xs12 sm4 md3 text-right pr-2 pl-2 pl-md-0 pr-md-4 pb-2>
            <v-text-field
              v-model="keyword1"
              dense
              class="rounded-0"
          ...
          <v-flex xs12 sm4 md2 text-right pr-2 pl-2 pl-md-0 pr-md-4 pb-2>
            <v-menu
              ref="menu"
              v-model="menu"
                    ...
                    <v-layout wrap justify-center>
                        ...
                        <v-layout wrap justify-start>
                          <v-flex xs12>
                            <v-img
                              ...
                              :src="mediaUURL + item.houseBoatId.coverImage"
                              :height="
                                $vuetify.breakpoint.name == 'xs'
                                  ? '180px'
                                  : $vuetify.breakpoint.name == 'sm'
                      ...
                      <v-flex xs9 pl-6>
                        <v-layout wrap justify-start fill-height>
                            ...
                            <v-layout wrap fill-height>
                              ...
                              <!-- <v-flex xs12 pt-2 align-self-end>
                                ...
                                >
                                  ...
                                  >
                                    {{ item.houseBoatId.location[0].name }}
                                  </span>
                                </span>
                              </v-flex> -->
                            </v-layout>
                          ...
                          >
                            <v-layout wrap fill-height>
                              <v-flex xs12 v-if="item.userid" align-self-start>
                                <span
                                  style="
                                    font-weight: 400;
                                    font-size: 14px;
                              ...
                              <v-flex xs12 text-left pt-2 align-self-end>
                                ...
                                >
                                  ...
                                  <span
                                    style="color: #f17343"
                                    v-if="item.advanceAmountPaid"
                                  >
                                    ₹ {{ item.advanceAmountPaid }}
                                  </span>
                                </span>
                              </v-flex>
                          ...
                          <v-flex xs3 align-self-center>
                            <v-layout wrap justify-end>
                              ...
                              <v-flex xs12 text-center pr-0 pr-md-2 pb-3>
                                <v-btn
                    ...
                    <v-layout wrap justify-center>
                      ...
                      <v-flex xs12>
                        <v-layout wrap justify-center fill-height>
                          ...
                          <v-flex xs11 pt-1 pt-md-3 text-left align-self-center>
                            <v-layout wrap justify-center>
                              <v-flex xs12 text-left v-if="item.userid">
                                <span
                                  style="
                                    font-weight: 400;
                                    font-size: 14px;
