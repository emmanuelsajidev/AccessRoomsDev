              ...
              <v-layout wrap justify-start>
                ...
                <v-flex xs12 sm6>
                  <v-layout wrap justify-center>
                    ...
                    <!-- <v-flex xs12 sm5 pt-4 pr-0 pr-sm-4 text-left>
                      ...
                      >
                        ...
                        <v-time-picker
                          ...
                          v-model="firstDayStartTime"
                          full-width
                          @click:minute="$refs.menu5.save(firstDayStartTime)"
                        ></v-time-picker>
                      </v-menu>
                    </v-flex>
                    <v-flex xs12 sm5 pt-4 text-left>
                      ...
                      >
                        ...
                        <v-time-picker
                          ...
                          v-model="firstDayEndTime"
                          full-width
                          @click:minute="$refs.menu6.save(firstDayEndTime)"
                        ></v-time-picker>
                      </v-menu>
                    </v-flex> -->
                  ...
                  <v-layout wrap justify-center pt-16>
                    <v-flex xs12 sm10 align-self-end text-right pt-10 mt-5>
                      <v-btn
                        @click="validation()"
                        width="150px"
                        class="btnstly"
