    ...
    <v-layout wrap justify-center pa-4>
      <v-flex xs12>
        ...
        <v-layout wrap justify-space-around pt-2>
          <v-flex xs12>
            <v-card tile class="pa-1 pa-sm-2 pa-md-8" elevation="0">
              <v-layout wrap mt-4 v-if="boatData.mealPlan">
                ...
                <v-flex xs12 pl-2 v-if="IsMealplan == false"
                  ><span
                    style="
                      font-family: LexendFont;
                      font-weight: 400;
                  ...
                  <v-layout wrap>
                    ...
                    <v-flex xs12 sm2 align-self-center text-left px-2>
                      <v-layout wrap>
                        ...
                        <v-flex xs3 sm12 align-self-center pt-1 pt-sm-0>
                          <span
                            v-if="boatData.maxPersonPerRoom"
                            style="
                              color: black;
                              font-family: LexendFont;
                              font-weight: 300;
                            ...
                            "
                          >
                            : {{ boatData.maxPersonPerRoom }}</span
                          >
                          <span v-else>-</span></v-flex
                        >
                      </v-layout>
                    ...
                    <v-flex xs12 sm2 align-self-center text-left px-2>
                      <v-layout wrap>
                        ...
                        <v-flex xs3 sm12 align-self-center pt-1 pt-sm-0>
                          <span
                            v-if="boatData.extraPersonPerRoom"
                            style="
                              color: black;
                              font-family: LexendFont;
                              font-weight: 300;
                            ...
                            "
                          >
                            : {{ boatData.extraPersonPerRoom }}</span
                          >
                          <span v-else>-</span></v-flex
                        >
                      </v-layout>
                    ...
                    <v-flex xs12 sm2 align-self-center text-left px-2>
                      <v-layout wrap>
                        ...
                        <v-flex xs3 sm12 align-self-center pt-1 pt-sm-0>
                          <span
                            v-if="boatData.firstDayStartTime"
                            style="
                              color: black;
                              font-family: LexendFont;
                              font-weight: 300;
                            ...
                            "
                          >
                            : {{ boatData.firstDayStartTime }}</span
                          >
                          <span v-else>-</span>
                        </v-flex>
                      </v-layout>
                    ...
                    <v-flex xs12 sm2 align-self-center text-left px-2>
                      <v-layout wrap>
                        ...
                        <v-flex xs3 sm12 align-self-center pt-1 pt-sm-0>
                          <span
                            v-if="boatData.secondDayStartTime"
                            style="
                              color: black;
                              font-family: LexendFont;
                              font-weight: 300;
                            ...
                            "
                          >
                            : {{ boatData.secondDayStartTime }}</span
                          >
                          <span v-else>-</span></v-flex
                        >
                      </v-layout>
                    ...
                    <v-flex xs12 sm2 align-self-center text-left px-2>
                      <v-layout wrap>
                        ...
                        <v-flex xs3 sm12 align-self-center pt-1 pt-sm-0>
                          <span
                            v-if="boatData.secondDayEndTime"
                            style="
                              color: black;
                              font-family: LexendFont;
                              font-weight: 300;
                            ...
                            "
                          >
                            : {{ boatData.secondDayEndTime }}</span
                          >
                          <span v-else>-</span></v-flex
                        >
                      </v-layout>
            ...
            <v-layout wrap justify-center>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                ...
                <v-text-field
                  ...
                  outlined
                  type="text"
                  v-model="curItem.minCapacityOfBoat"
                  hide-details="auto"
                >
                </v-text-field>
              </v-flex>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                <span class="title2">Maximum person / room</span>
                <v-text-field
                  dense
                  outlined
                  type="text"
                  v-model="curItem.maxPersonPerRoom"
                  hide-details="auto"
                >
                </v-text-field>
              </v-flex>
            ...
            <v-layout wrap justify-center>
              <v-flex xs12 sm10 pt-4 text-left>
                ...
                <v-dialog
                  ref="menu5"
                  v-model="menu5"
                  :return-value.sync="curItem.firstDayStartTime"
                  persistent
                  width="290px"
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="curItem.firstDayStartTime"
                      hide-details="auto"
                      v-bind="attrs"
                      v-on="on"
                      outlined
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="#f17343"
                      @click="$refs.menu5.save(curItem.firstDayStartTime)"
                    >
                      OK
                    </v-btn>
                  </v-time-picker>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                ...
                <v-dialog
                  ref="menu6"
                  v-model="menu6"
                  :return-value.sync="curItem.firstDayEndTime"
                  persistent
                  width="290px"
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="curItem.firstDayEndTime"
                      hide-details="auto"
                      v-bind="attrs"
                      v-on="on"
                      outlined
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="#f17343"
                      @click="$refs.menu6.save(curItem.firstDayEndTime)"
                    >
                      OK
                    </v-btn>
                  </v-time-picker>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                ...
                <v-dialog
                  ref="menu7"
                  v-model="menu7"
                  :return-value.sync="curItem.secondDayStartTime"
                  persistent
                  width="290px"
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="curItem.secondDayStartTime"
                      hide-details="auto"
                      v-bind="attrs"
                      v-on="on"
                      outlined
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="#f17343"
                      @click="$refs.menu7.save(curItem.secondDayStartTime)"
                    >
                      OK
                    </v-btn>
                  </v-time-picker>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                ...
                <v-dialog
                  ref="menu8"
                  v-model="menu8"
                  :return-value.sync="curItem.secondDayEndTime"
                  persistent
                  width="290px"
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="curItem.secondDayEndTime"
                      hide-details="auto"
                      v-bind="attrs"
                      v-on="on"
                      outlined
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="#f17343"
                      @click="$refs.menu8.save(curItem.secondDayEndTime)"
                    >
                      OK
                    </v-btn>
                  </v-time-picker>
              ...
              <v-flex xs12 sm10 pt-4 text-left>
                <span class="title2">Extra person / room</span>
                <v-text-field
                  dense
                  outlined
                  type="text"
                  v-model="curItem.extraPersonPerRoom"
                  hide-details="auto"
                >
                </v-text-field>
              </v-flex>
          ...
          <v-layout wrap justify-start>
            <v-flex xs12>
              <v-layout wrap justify-center>
                ...
                <v-flex xs12 sm10 pt-4 text-left>
                  <span class="title2 pr-2"
                    >Customer extra person rate (₹)</span
                  >
                  <v-text-field
                    dense
                    outlined
                ...
                <v-flex xs12 sm10 pt-4 text-left>
                  <span class="title2 pr-2">Agent extra person rate (₹)</span>
    ...
    edit1() {
      ...
      axios({
        ...
        data: {
          ...
          extraPersonPerRoom: this.curItem.extraPersonPerRoom,
          checkOutTime: this.curItem.checkOutTime,
          firstDayEndTime: this.curItem.firstDayEndTime,
          firstDayStartTime: this.curItem.firstDayStartTime,
          maxCapacityOfBoat: this.curItem.maxCapacityOfBoat,
          maxPersonPerRoom: this.curItem.maxPersonPerRoom,
          minCapacityOfBoat: this.curItem.minCapacityOfBoat,
          secondDayEndTime: this.curItem.secondDayEndTime,
          secondDayStartTime: this.curItem.secondDayStartTime,
    ...
    add() {
      ...
      axios({
        ...
        if (response.data.status == true) {
          ...
          this.season.agentExtraRate = "";
          this.season.customerExtraRate = "";
          location.reload();
        } else {
          this.msg = response.data.msg;
          this.showSnackbar = true;
