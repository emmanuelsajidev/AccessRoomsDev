      ...
      <v-flex xs12 align-self-center>
        <v-card tile class="pa-0 pa-md-4">
              ...
              <v-img
                ...
                <v-layout justify-start fill-height>
                  ...
                  <v-flex xs8 align-self-end mb-4>
                    ...
                    >
                    <span
                      v-if="HouseboatData.shikaraStatus == 'Blocked'"
                      style="
                        font-weight: 600;
                        font-size: 18px;
                        color: red;
          ...
          <v-layout
            ...
            my-4
          >
            <v-flex xs12 sm2 md4 align-self-center>
              <v-layout wrap pa-2 pa-md-0>
                <v-flex xs6 sm12 md4 align-self-center text-center>
                  <span
                    style="
                      font-family: LexendFont;
                      font-weight: 600;
              ...
              <v-layout wrap justify-start>
                ...
                <v-flex xs12 sm2 py-2 pr-0 pr-md-2 align-self-end>
                  <v-btn
                    ...
                    dark
                    :disabled="
                      HouseboatData.shikaraStatus === 'Blocked' ? true : false
                    "
                    @click="
                      $router.push(
