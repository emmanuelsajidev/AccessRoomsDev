                    ...
                    <v-flex xs12 sm10 pt-4 text-left>
                      ...
                      >
                        <template v-slot:append>
                          <v-btn dense class="hidden-xs-only btnstly" small
                            ><span style="color: white"
                              >Choose File</span
                            ></v-btn
                          >
  ...
  methods: {
    winStepper(window_data) {
      ...
      if (window_data.type == "image") {
        ...
        console.log("imageArray new=", this.imageArray);
        console.log("imageFiles new=", this.imageFiles);
    ...
    addBoat() {
      ...
      facilities.toilet = this.toilet;

      axios({
        method: "POST",
        url: "/shikara/add",
        data: {
          shikaraName: this.shikaraName,
