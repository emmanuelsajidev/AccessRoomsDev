                ...
                <v-layout justify-start fill-height>
                  ...
                  <v-flex xs2 align-self-end text-right mb-4 pr-8>
                    <v-btn
                      ...
                      color="grey"
                      @click="(editDialog = true), (curItem = HouseboatData)"
                    >
                      <span
                        style="
                          font-family: LexendFont;
                ...
                <v-card-text>
                  <v-layout wrap justify-end>
                    <v-flex
                      xs1
                      text-right
                      @click="(EditTrip1 = true), (editItem1 = Item1)"
                    >
                      <span
                        style="
                          color: #ff6200;
                          ...
                          font-size: 18px;
                        "
                        ><v-icon color="#ff6200" small>mdi-pencil</v-icon
                        >Edit</span
                      >
                    </v-flex>
                  </v-layout>
                ...
                <v-card-text>
                  <v-layout wrap justify-end>
                    <v-flex
                      xs1
                      text-right
                      @click="(EditTrip2 = true), (editItem2 = Item2)"
                    >
                      <span
                        style="
                          color: #ff6200;
      ...
      <v-card width="600px" class="pa-4">
        <v-layout wrap justify-center>
          ...
          <v-flex xs1 text-right>
            <v-icon @click="editDialog = false" color="#002635"
          ...
          <v-flex xs11 text-center
            ><span
              style="
                ...
                font-weight: 400;
              "
              >Edit Day Cruise</span
            ></v-flex
          >
          <v-flex xs1 text-right>
            <v-icon @click="EditTrip1 = false" color="#002635"
              >mdi-close-box</v-icon
            ></v-flex
          >
          <v-flex xs8 text-center py-4>
